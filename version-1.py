...
class TrigramModel(object):
    ...
    def sentence_logprob(self, sentence):
        ...
        for trigram in trigrams:
            # print(trigram)
            # print("Trigram Count", self.trigramcounts.get(trigram, 0))
            # print("Raw Trigram Probability", self.raw_trigram_probability(trigram))
    ...
    def perplexity(self, corpus):
        ...
        for sentence in corpus:
            ...
            # total_words += len(sentence) - 2  # START, STOP should not be counted
            total_words += len(sentence)
        
        # print("Log Probability Sum", log_prob_sum)
...
if __name__ == "__main__":
    ...
    print("raw probab")
    print("Using 1/size-of(lexicon) - For Bigram Probability")
